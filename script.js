...
function troll() {
    ...
    const y = document.getElementById("fbut3");
      ...
      document.getElementById("alert2").innerHTML = "Cậu mà thoát trang Web này là tớ cạp cậu nha 😛";
      document.getElementById("audio2").play();
      return false;
}
function troll1() {
...
function inrel() {
    ...
    const b = document.getElementById("fbut2alt");
     ...
     c.innerHTML = "";
     c.innerHTML = "Ai nớp diu sâu mắc";
     y.style.display="none";
...
function trollalt() {
    document.getElementById("alert2").innerHTML="Sao cậu không muốn? Tớ cắn giờ?!";
    alert("Sao cậu không muốn? Tớ cắn giờ?!");
    return false;
}
